...
const foodSound = new Audio("../js/yamate2.mp3");
const gameOverSound = new Audio("../js/DeathSound.mp3");
const moveSound = new Audio("../js/moveSound.mp3");
const musicSound = new Audio("../js/BGsound2.mp3");
let speed = 10;
let score = 0;
let lastPaintTime = 0;
